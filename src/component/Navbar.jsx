...
const Navbar = ({ isOpen, setIsOpen }) => {
    ...
    return (
        <div className='px-8 sm:px-12 lg:px-24 xl:px-40 flex max-sm:justify-between max-sm:pt-5 max-sm:flex-col gap-5 pt-5'>
            ...
            <div className={`${isOpen ? "max-sm:block max-sm:relative " : "max-sm:hidden overflow-hidden max-sm:absolute "}max-sm:rounded-sm  max-sm:mt-4 rounded-lg  max-sm:bg-[hsl(257, 27%, 26%)] sm:flex sm:items-center sm:justify-between w-[100%] `}>

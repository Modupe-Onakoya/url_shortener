    ...
    return (
        <div className='px-8 px-8 sm:px-12 lg:px-24 xl:px-40 sm:flex flex-row justify-between items-center'>
            ...
            <div className='sm:space-y-3'>
                <p className='max-sm:text-center flex flex-col font-bold text-4xl sm:text-7xl pt-2'>
                    More than just <span>shorter links</span>
                </p>
                <p className='max-sm:flex max-sm:flex-col max-sm:items-center text-gray-400 pt-2 sm:text-xl'>
